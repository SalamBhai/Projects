...
namespace TheLogoPhilia.Implementations.Services
{
    public class ApplicationUserService : IApplicationUserService
    {
        ...
        public async Task<BaseResponse<ApplicationUserViewRequestModel>> CreateApplicationUser(ApplicationUserCreateRequestModel model)
        {
            ...
            //     userImage = $"Admin{Guid.NewGuid().ToString().Substring(0,9)}.{adminImageType}";
             //     var fullPath = Path.Combine(adminPhotoPath,userImage);
            //     if(adminImageType.ToLower() != "jpg" || adminImageType.ToLower() != "jpeg" || adminImageType.ToLower() != "png")
               //     {
          ...
          var applicationUser= new ApplicationUser
          {
              ...
              LastName =  model.LastName,
                ...
                UserId = newUser.Id,
                // ApplicationUserImage = userImage,
          };
