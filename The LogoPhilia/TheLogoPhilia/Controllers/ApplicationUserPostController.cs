...
namespace TheLogoPhilia.Controllers
{
    ...
    public class ApplicationUserPostController : ControllerBase
    {
        ...
        public ApplicationUserPostController(IApplicationUserPostService applicationUserPostService, IPostLogRepository postLogRepository, IHostingEnvironment hostingEnvironment)
        {
